...
void StvenantFpNumFlux(double wL[],double wR[],double* vnorm,double* flux){
  ...
  double vn =
    stvenant_v[0] * vnorm[0] +
    stvenant_v[1] * vnorm[1] +
    stvenant_v[2] * vnorm[2];
...
void StvenantFpNumFlux2d(double wL[],double wR[],double* vnorm,double* flux){
  ...
  double vn =
    stvenant_v2d[0] * vnorm[0] +
    stvenant_v2d[1] * vnorm[1] +
    stvenant_v2d[2] * vnorm[2];
